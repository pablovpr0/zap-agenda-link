...
const ScheduleSettings = ({ onScheduleUpdate }: ScheduleSettingsProps) => {
  const { user } = useAuth();
                ...
                <div className="space-y-4 ml-4 border-l-2 border-green-200 pl-4">
                  ...
                  <div className="flex items-center space-x-2 pt-2 border-t border-gray-200">
                    <Switch
                      ...
                      onCheckedChange={(checked) => 
                        updateSchedule(schedule.day_of_week, { has_lunch_break: checked })
                      }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pl-4 border-l border-orange-200">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => 
                            updateSchedule(schedule.day_of_week, { lunch_start: e.target.value })
                          }
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => 
                            updateSchedule(schedule.day_of_week, { lunch_end: e.target.value })
                          }
                          className="text-sm h-9 border-gray-300 focus:border-orange-500"
                        />
                      </div>
                  ...
                  <div className="text-xs text-gray-500 bg-white p-2 rounded border">
                    ...
                    {schedule.has_lunch_break && schedule.lunch_start && schedule.lunch_end && (
                      <span> (Almoço: {schedule.lunch_start} às {schedule.lunch_end})</span>
                    )}
                  </div>
                </div>
              )}
