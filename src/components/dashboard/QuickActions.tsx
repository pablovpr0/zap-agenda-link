...
const QuickActions = ({ onNewAppointment, onViewPublicPage, onManageClients, onShowSettings }: QuickActionsProps) => {
  return (
      ...
      >
        <CardContent className="p-4 md:p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-medium text-gray-800">⚙️ Configurações</h3>
